...
- [ ] Given a tab is focused, when using the Home key, then the first tab becomes focused.
- [ ] Given a tab is focused, when using the End key, then the last tab becomes focused.
