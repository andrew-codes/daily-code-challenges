...
- [x] Given a spacing value as a number, when rendering a group of components, then the spacing unit is pixels.
- [ ] Given a spacing value as a string and has no unit of measurement, when rendering a group of components, then the spacing unit is pixels.
- [ ] Given a spacing value as a string with a unit of measurement, when rendering a group of components, then the spacing unit is the same as the units provided by the string.
